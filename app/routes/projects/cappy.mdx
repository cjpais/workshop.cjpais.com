...
[Cappy](https://cappy.space) (now defunt) is one of the many projects to come from the ['Mac Mini Network'](https://andromeda.computer). These days it's effectively self-hosted S3 using [Garage](https://garagehq.deuxfleurs.fr) on a variety of friend's computers.
