...
Footy is a DIY foot pedal for your computer. Combined with a speech-to-text
app, it's a fun and unique way to compute using your feet.
...
and I want to share how you can build a Footy for yourself to explore 
the world of foot computing.

![Footy Foot Pedal](/images/footy/footy.jpeg "footy in all its glory")

## Background

I broke my finger on January 2nd and was put into a cast soon after.
